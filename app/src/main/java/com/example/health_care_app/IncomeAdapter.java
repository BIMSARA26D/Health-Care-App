...
public class IncomeAdapter extends ArrayAdapter<Income_Model> {

    ArrayList<Income_Model> dataList;
    Context context;
    int resource;


    public IncomeAdapter(@NonNull Context context, int resource, @NonNull List<Income_Model> objects) {
        super(context, resource, objects);

        this.dataList = (ArrayList<Income_Model>) objects;
    ...
    @Nullable
    @Override
    public Income_Model getItem(int position) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Income_Model item_model = getItem(position);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, EditDeleteIncome.class);
