...
public class Expenses extends AppCompatActivity {
    ...
    private ArrayList<Expenses_Model> dataList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button income = findViewById(R.id.btnAddExpenses);
    ...
    void getDataAllData(){
        ...
        ExpensesAdapter itemAdapter = new ExpensesAdapter(this, R.layout.ly_income_card, dataList);

        //ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, dataList);
        loadData.setAdapter(itemAdapter);

        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("tblExpenses");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1: snapshot.getChildren()){
                    ...
                    Expenses_Model item_model = snapshot1.getValue(Expenses_Model.class);
                    ...
                    dataList.add(new Expenses_Model(getKey, getId, getValue, getReason, getDate));
                }
