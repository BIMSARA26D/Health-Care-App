...
public class EditDeleteIncome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_delete_income);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        setTitle("Edit / Delete Income");
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(EditDeleteIncome.this);
    ...
    void deleteData(){
        ...
        reference.child("tblIncome").child(getKey).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(EditDeleteIncome.this, "Successfully Deleted!!", Toast.LENGTH_SHORT).show();
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(EditDeleteIncome.this, "Error.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void validate(){
        ...
        if(getId.isEmpty()){
            ...
            String key = getKey;
            mDatabase.child("tblIncome").child(key).setValue(income_model).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {
                    progressDialog.dismiss();
                    Toast.makeText(EditDeleteIncome.this, "Successfully Updated!!", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(Exception e) {
                    ...
                    Toast.makeText(EditDeleteIncome.this, "Fail try again.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void loadDate(){
        ...
        date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(EditDeleteIncome.this,date1,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
